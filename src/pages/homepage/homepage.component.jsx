...
const HomePage = () => {
    ...
    return(
        ...
        <img className = "ban" src="https://illamthedikalvi.tnschools.gov.in/assets/images/Banner%202.png" width = "1300" alt="banner"/>
            <div className = "ilam">
                <div>
                    <h4><b>இல்லம் தேடிக் கல்வி</b></h4>
                    <p><b>தமிழ்நாடு அரசு</b> பள்ளிக் கல்வித் துறையின் ஒரு முன்முயற்சி</p>
                </div>
            </div>
        ...
        <div className="bottom">
            ...
            <div className="right">
                <p><b>வணக்கம்!</b> <br/><b>இல்லம் தேடிக் கல்வி ஒரு தன்னார்வ தொண்டு.</b> கொரோனா பெருந்தொற்றுப் பரவல் சார்ந்த பொது முடக்க காலங்களில் அரசு பள்ளிகளில் ஒன்று முதல் எட்டாம் வகுப்பு வரை பயிலும் மாணவர்களின் கற்றல் இடைவெளி மற்றும் இழப்புகளை சரி செய்ய இல்லம் தேடிக் கல்வித் திட்டம் செயல்படுத்தப்பட உள்ளது. பள்ளி முடிந்த பின்பு மாலை நேரங்களில் 'இல்லம் தேடிக் கல்வி' மையங்களில் கற்பித்தல் சேவையை மேற்கொள்ள உள்ள தன்னார்வலர்கள் பதிவு செய்ய ஏதுவாக, படிவம் இவ்விணைய தளத்தில் வழங்கப்பட்டு உள்ளது.</p>
            </div>
        </div>
        <div className="down">
            <p><b>தன்னார்வலர்கள்..</b></p>
            <React.Fragment>
                <tr><td>1.வாரத்திற்கு குறைந்தது ஆறு மணி நேரம் குழந்தைகளுடன் செலவிட தயாராக இருக்க வேண்டும் (அல்லது) பகுதி நேரமாகவும் தன்னார்வலராக இருக்கலாம்.</td></tr>
                <tr><td>2.கண்டிப்பாக குழந்தைகளுடன் உரையாட தமிழ் தெரிந்திருக்க வேண்டும்</td></tr>
                <tr><td>3.தமிழ், ஆங்கிலம், மற்றும் கணிதம் கற்றுத்தர வேண்டும். (பயிற்சிகளும் உபகரணங்களும் வழங்கப்படும்)</td></tr>
                <tr><td>4.யார் நிர்பந்தமும் இன்றி தன்முனைப்பாக பங்கேற்க வேண்டும்</td></tr>
                <tr><td>5.குறைந்தபட்சம் <b>17 வயது</b> நிரம்பி இருத்தல் அவசியம்</td></tr>
            </React.Fragment>
        </div>
        <div className = "formi">
            <FormDialog/>
